...
public class ServerMonitorService {
    ...
    public boolean isSshConfigured() {
        return !host.isBlank() && !sshPass.isBlank();
    }
    ...
    public List<Map<String, String>> getContainers() throws Exception {
    ...
    public String containerAction(String name, String action) throws Exception {
        String out = exec("docker " + action + " " + name + " 2>&1");
        cache.set(null);
        return out.trim();
    }

    public String getContainerLogs(String name, int lines) throws Exception {
